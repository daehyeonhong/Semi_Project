...
<body>
	...
	<fmt:bundle basename="bundle.message">
     ...
     href="?변수명=값" -->
			...
			<form name="newProduct" action="${pageContext.request.contextPath}/admin/processAddProduct.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
