					...
					<div class="form-group row">
						<div class="container" style="width: 700px;">
							<button type="submit" class="btn btn-success btn-lg" id="btn"
								value="등록" onclick='location.href="addMember.jsp"'>회원가입
								완료</button>
							<button type="reset" class="btn btn btn-lg" id="btn" value="취소"
								onclick='location.href="welcome.jsp"'>회원가입 취소</button>
						</div>
				</form>
			</div>
			<jsp:include page="/footer.jsp" />
