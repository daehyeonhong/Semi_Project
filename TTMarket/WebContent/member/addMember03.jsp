...
=======
<%@ page contentType="text/html; charset=UTF-8"%>
>>>>>>> a3b640ef16da6647ab95ab64aa0724447e01c84f
...
$(document).ready(function(){
	...
	$('#dupCheck').click(function(){
		...
		$.ajax({
			...
			url:'idcheck03_ajax.jsp?id='+$('#id').val(),// val('success')
...
<form name="newMember" class="form-horizontal" 
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-3">
	    	...
	    	<input type="button" value="중복확인" class="btn btn-primary" id="dupCheck">
...
<<<<<<< HEAD
<<<<<<<< HEAD:TTMarket/WebContent/member/addMember03.jsp
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
<style>
body{position: absolute; margi:0; padding:0;}
#context1{
	position:relative;
...
</script>  아래는 jquery로 바꾸기-->
<script>
function btnEmail() {
	let email =document.getElementById('mail1').value;
	let com = document.getElementById('mail2').value;
/* 	alert(email+com); */
	window.open("./mailConfirm.jsp?mail1="+email+"&mail2="+com,'','width=500,height=300');
}
function chechForm(){
...
<form name="newMember" class="form-horizontal" id="newMember"
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-3">
	   		 <input name="id" id="id" class="form-control" placeholder="id">
	    <input type="button" value="중복확인" class="btn btn-primary" id="dupCheck" required>
	    	<input type="hidden" id="idChecked" name="idChecked" value='false'>
	    	<label id="result" class="badge badge-success"></label>
	    </div>
	</div>
	...
	<div class="form-group row">
	    ...
	    <input name="birthyy" maxlength="4" placeholder="년(4자)" size="6">년 &nbsp;
	    	...
	    	<input name="birthdd" maxlength="2" placeholder="일" size="4">일
	    </div>
	</div>
	<div class="form-group row">
	    <label class="col-sm-2">이메일</label>
	    <div class="col-sm-10">
	    	...
	    	<select name="mail2" id="mail2" required>
	    	 ...
	    	 <input type="button" onclick='btnEmail()' value="이메일 인증">
	    </div>
	</div>
	<div class="form-group row">
	    <label class="col-sm-2">전화번호</label>
	    <div class="col-sm-10">
	    	<!-- <input name="phone" maxlength="20" class="form-control" placeholder="phone"> -->
	    	<input name="phone1" maxlength="3" size="4" required>-
	...
	<div class="form-group row">
	    <label class="col-sm-2">우편번호</label>
	    <div class="col-sm-10">
	    	<input type="text" id="postcode" placeholder="우편번호" name="postcode" required>
             <input type="button" onclick="execDaumPostcode()" value="우편번호 찾기"><br>
	    </div>
	</div>
	...
	<div class="form-group row">
	    <label class="col-sm-2">주소</label>
	    <div class="col-sm-10">
	    	<input name="address" id="address" class="form-control" placeholder="address" required>
	    </div>
	</div>
	...
	<div class="form-group row">
	   <label class="col-sm-2">회원 등급</label>
	    <div class="col-sm-10" >
	    	...
	    	<input name="Green" type="radio" disabled>Green
	    	<input name="Gold" type="radio" disabled >Gold
	    	<input name="VIP" type="radio" disabled>VIP
	    	<input name="VVIP" type="radio" disabled>VVIP
	    </div>
	</div>
...
>>>>>>>> a3b640ef16da6647ab95ab64aa0724447e01c84f:WebMarket17/WebContent/member/addMember.jsp
=======
