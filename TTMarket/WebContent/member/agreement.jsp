...
$(document).ready(function(){
	...
	$("#1, #2, #3, #4").click(function(){
		if($(this).attr('src')=="../resources/images/check.jpg"){
			$(this).attr("src","../resources/images/checked.jpg");
		}else{
			$(this).attr("src","../resources/images/check.jpg");
		}
	});
});

 function btm_success(){

var on1 = document.getElementById("1");
var on2 = document.getElementById("2");
var on3 = document.getElementById("3");
	 if(on1.src.match("../resources/images/checked.jpg")
	 && on2.src.match("../resources/images/checked.jpg")
	 && on3.src.match("../resources/images/checked.jpg")){
		 location.assign("./addMember.jsp");
	 	}else{
	...
	<div class="container" align="center">
		<div class="context">
			<form style="width: 500px;">
				...
				<!-- 		 <strong class="glyphicon glyphicon-ok-circle" id="icon"></strong>  -->
				<p style="font-weight: bolder; text-align: left; width: 500px;"
					id="all">
					<img src="../resources/images/check.jpg" id="all1">이용약관, 개인정보 수집 및 이용,
					위치정보 이용약관(선 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;택),프로모션 안내 메일
					수신(선택)에 모두 동의합니다.
				</p>
...
전화번호 : TTMarket@google.com
이메일 주소 : TTMarket@google.com
					</textarea>
				</fieldset>
				<hr>
				<p id="select_option"
					style="font-weight: bolder; text-align: left; width: 500px;">
					<img src="../resources/images/check.jpg"  id="4">이벤트 등 프로모션 알림 메일 수신<span>(선택)</span>
				</p>
