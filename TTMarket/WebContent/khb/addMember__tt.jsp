...
function checkpwd(){
	if ($('#password_confirm').val()!=$('#password').val()){
		// 같지 않으면
		  $('#resultpwd').removeClass();//동적으로   class제거

		  $('#resultpwd').addClass("badge badge-danger");

		  $('#resultpwd').html('비밀번호가 일치하지 않습니다.');

		  $('#password_confirm').val('');

		  $('#password_confirm').focus();

		  $('#password_confirm').attr('readonly',false);

		}else{//사용가능하면  success값

		  $('#resultpwd').removeClass();//동적으로   class제거

		  $('#resultpwd').addClass("badge badge-success");

		  $('#resultpwd').html('비밀번호가 일치합니다.');	

		/*    $('#name').focus();  */

		  $('#password').attr('readonly',true);//수정불가처리

		  $('#password_confirm').val('true');
...
<form name="newMember" class="form-horizontal" 
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-3">
	    	...
	    	<div class="col-sm-20"><input class="col-sm-6" name="id" id="id" class="form-control" placeholder="id">

	    	<input type="button" value="중복확인" class="btn btn-primary" class="col-sm-2"
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-3">
	    	...
	    	<input type="password" id="password_confirm" name="password_confirm" class="form-control" placeholder="password_confirm"
	    	 >

<!-- <input type="hidden" id="pwdChecked" name="pwdChecked" value='false'> -->

	    	<label id="resultpwd" class="badge badge-success"></label> 
	...
	<div class="form-group row">
	    ...
	    <div class="col-sm-3">
	    	...
	    	<input name="name" id="name" class="form-control" placeholder="name" onfocus="checkpwd()">
